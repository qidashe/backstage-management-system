    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item> <i class="el-icon-lx-cascades"></i> 首页帖子管理 </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="gname" label="板块"></el-table-column>
                ...
                <el-table-column label="操作" width="180" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button type="text" icon="el-icon-delete" class="red" @click="handleRemove(scope.$index, scope.row)"
                            >移除</el-button
                        >
